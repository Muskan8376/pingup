...
// <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-mdspace-y-4'>
...
//    </div>
//   <p className='text-sm text-gary-500'>@{user.username}</p>
// {/* </div> */}
//       {/* </div> */}

//       {/* Text Area */}
//       <textarea  className='w-full resize-none max-h-20   mt-10 text-sm outline-none placeholder-gray-400' placeholder="What's Happening?" onChange={(e)=>setContent(e.target.value)} value={content}/>
      ...
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          <div className='flex items-center justify-between py-3 border-t border-gray-300'>
            ...
            onClick={() =>
  toast.promise(
    handleSubmit(), // make sure handleSubmit returns a Promise
    {
      loading: 'Uploading...',

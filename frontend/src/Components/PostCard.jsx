...
<div>
    ...
    <div className='text-gray-500 text-sm'>
       @{post.user.username}.{moment(
post.createdAt).fromNow()} </div>
      ...
      <div className='grid grid-cols-2 gap-2'>
        {
            ...
            <img src={img} alt="" key={index}  className={`w-full h-48 object-cover rounded-lg ${post.image_urls.length === 1
                && 'col-span-2 h-auto'
            }`}/>
            ))
        }
      ...
      <div className='flex items-center gap-4 text-gray-600 text-sm pt-2 border-t border-gary-300'>

...
e.preventDefault();
  ...
  return (
            ...
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="profile_picture" className='black text-sm font-medium text-gray-700 mb-1'>
                            Profile Picture
    ...
    <div className='group/cover relative'>
        <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo} alt=""  className='w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-300 object-cover mt-2'/>
...
<div className='flex justify-end space-x-3 pt-6'>
    ...
    <button 
    type='Submit'
    className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer'>Save Changes </button>
</div>
